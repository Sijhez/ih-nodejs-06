//con este archivo vamos a poblar nuestra base de datos
//imports
const mongoose = require('mongoose')
const Anime = require('./../models/Anime')

//importar variable de entorno para importar base de datos
...
// connect DB
//nos vamos a conectar a la base de datos, NO AL PUERTO, abusadillo
mongoose.connect(process.env.MONGODB)

//function to populate DB
//vamos a generar los animes dentro de la base de datos

const generateAnimes = async ()=>{
    await Anime.create(animes)
    console.log('Base de datos poblada con animes chinos kawais :3')
   //aqui cerramos la coneccion con la base de datos, si no se cierra el canal se queda abierto, y sale mas caro XD
